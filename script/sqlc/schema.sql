...
CREATE TABLE `admission_major` (
  ...
  `major` varchar(250) DEFAULT NULL COMMENT '专业',
  `select_exam` varchar(100) DEFAULT NULL COMMENT '选考',
  `province` varchar(50) DEFAULT NULL COMMENT '省份',
  `admission_type` varchar(100) DEFAULT NULL COMMENT '招生类型',
  `admission_time` char(4) DEFAULT NULL COMMENT '招生年份',
  `admission_number` varchar(100) DEFAULT NULL COMMENT '招生人数',
  `duration` varchar(100) DEFAULT NULL COMMENT '学制',
  `max_score` varchar(100) DEFAULT NULL COMMENT '最高分',
  `min_score` varchar(100) DEFAULT NULL COMMENT '最低分',
  `average_score` varchar(100) DEFAULT NULL COMMENT '平均分',
  `province_control_score_line` varchar(100) DEFAULT NULL COMMENT '省控制分数线',
  `score_rank` varchar(100) DEFAULT NULL COMMENT '分数排名',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
